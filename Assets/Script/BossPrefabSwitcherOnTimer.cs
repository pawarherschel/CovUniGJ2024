...
namespace Script
{
    public sealed class BossPrefabSwitcherOnTimer : MonoBehaviour
    {
        ...
        public GameObject CurrentSprite
        {
            ...
            set
            {
                ...
                CurrentInternalController = _currentSprite.GetComponent<InternalBossController>();
                // currentAnimator = _currentSprite.GetComponent<Animator>();
            }
        }

        internal InternalBossController CurrentInternalController;
